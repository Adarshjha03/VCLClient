...
<div className="flex h-screen font-sans relative">
      ...
      <div className="flex-1" style={{ background: "#ffffff", overflowY: "hidden" }}>  
        ...
        <div
          className="container  mx-auto px-10 pt-8 py-8 flex flex-row space-x-4"
          style={{
            marginTop: "1px",
            overflowY: "hidden",
        ...
        > {/* Center align elements */}
          ...
          <div className="w-3/4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg h-auto mb-4">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 text-center">Solved Problems</h2>
