  ...
  const handleSubmitQuiz = async () => {
    try {
      ...
      setVerificationResponseMessage(`
        ...
        ${
          responseData.incorrect_answers
            ? `Incorrect Answers: ${responseData.incorrect_answers}`
            : ""
        }
      `);
    } catch (error) {
        ...
        <div className="px-4">
          <div className="container mx-auto pt-8 px-8 pb-2">
            <div className="mb-8 flex justify-between items-center font-semibold">
              {subAdmin && <EditQButton admin={subAdmin} />}
            </div>
            <div className="flex flex-wrap -mx-4">
              ...
              <div className="w-full sm:w-1/2 px-4">
                <div className="bg-white px-6 pb-4 rounded-lg shadow-lg max-h-[80vh] overflow-y-auto">
        ...
        />
                  ...
                  {verificationResponseMessage && (
                    <div className="mt-4 flex flex-col items-center">
                      ...
                      <pre className="mr-14 text-center">
                        {verificationResponseMessage}
                      </pre>
                    </div>
                  )}
