...
const Dashboard = () => {
                ...
                <div className="p-6">
                    ...
                    <div className="flex flex-col md:flex-row mb-6 gap-6">
                        <div className="w-full md:w-5/12 h-[40vh] bg-gray-100 rounded-lg p-3">
                            <h3 className="text-xl font-bold  text-center">Lab Distribution</h3>
                            <PieChart data={labsPerCategory} />
                        </div>
                        <div className="w-full md:w-7/12 h-[40vh] bg-gray-100 rounded-lg py-3 px-1">
                            <h3 className="text-xl font-bold mb-2 text-center">Most Solved</h3>
    ...
    <div className="flex h-full">
        ...
        <div className="flex-1 flex flex-col items-center p-4">
            ...
            <div className="mt-2 font-bold text-blue-600">TOP 3 Learners</div>
        </div>
    </div>
</div>
