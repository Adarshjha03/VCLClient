...
const Sidebar = ({ showMenu, onTopicSelect, activeTopic }) => {
  ...
  <img src={"https://cyber-range-assets.s3.ap-south-1.amazonaws.com/assets/" + (window.location.origin.includes("https://") ? window.location.origin.slice(7) : window.location.origin) + "/logo.png"} alt="HeadLogo" className="w-50 content-evenly mb-3" />
</div>
