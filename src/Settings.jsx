  ...
  return (
    <div className="flex h-screen font-sans-relative">
      ...
      <div
        ...
        style={{ background: "#ffffff", overflowY: "hidden" }}
      >
        ...
        <div className="p-6">
          {responseMessage && (
            <div
              className={`bg-${
                ...
                responseMessage.includes("success") ? "green" : "red"
              }-700 px-4 py-3 rounded -mt-3 mb-2`}
              role="alert"
            >
              {responseMessage}
            </div>
            ...
            <form onSubmit={handleProfileSubmit}>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setUser({ ...user, portfolioUrl: e.target.value })
                  }
                  className="p-2 border rounded"
                />
                <input
              ...
              <button
                type="submit"
                className="mt-4 px-4 py-2 bg-[#213099] text-white items-center rounded hover:bg-blue-600"
              >
                Update Profile
              </button>
            </form>
          ...
          <div className="mb-10 space-x-4  flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 md:pr-4">
              ...
              <form onSubmit={handlePasswordSubmit}>
                ...
                <button
                  type="submit"
                  className="mb-2 mt-2 px-4 py-2 bg-[#213099] text-white rounded hover:bg-blue-600"
                >
                  Update Password
                </button>
              </form>
                ...
                <form onSubmit={handleAddBonusPoints} className="mt-4">
                  <div className="flex items-center mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setNewBonusPoints(parseInt(e.target.value))
                      }
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 bg-[#213099] text-white rounded hover:bg-blue-600"
                  >
                    Add Points
                  </button>
                </form>
          ...
          {admin && (
            <div className="mb-10">
              ...
              <form onSubmit={handleChangeUserType} className="mt-4">
                ...
                <button
                  type="submit"
                  className="mt-2 px-4 py-2 bg-[#213099] text-white rounded hover:bg-blue-600"
                >
                  Change User Type
                </button>
              </form>
